  ...
  return (
    <div className="lg:hidden">
      ...
      <button
        ...
        className="flex items-center justify-center h-10 w-10 rounded-lg text-editor-muted hover:text-editor-text hover:bg-editor-hover transition-colors"
      ...
      {/* Drawer */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-editor-sidebar border-r border-editor-border transform transition-transform duration-300 ease-in-out ${
