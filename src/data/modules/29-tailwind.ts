  ...
  exercises: [
    ...
    },
    {
      ...
      retoPasos: [
        {
          instruccion:
            "LAYOUT: al div de la tarjeta agregale las clases `flex`, `flex-col` y `gap-3` para apilar su contenido con separación.",
        ...
        {
          instruccion:
            "TIPOGRAFÍA: al h3 agregale `text-xl` y `font-bold`.",
          esperado: ".tarjeta > h3.text-xl.font-bold",
        },
        {
          instruccion:
            "ESTADOS Y RESPONSIVE: al botón agregale `bg-blue-600`, `hover:bg-blue-700` y `md:w-auto`. Los prefijos son la forma que tiene Tailwind de expresar un estado o un breakpoint sin salir del HTML.",
          esperado:
