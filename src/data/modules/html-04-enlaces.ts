...
export const htmlEnlacesModule: ModuleData = {
  ...
  description:
    "Aprende a crear enlaces con la etiqueta <a>: enlaces externos, internos, de correo, teléfono y las diferencias entre URLs absolutas y relativas.",
  order: 4,
  dojo: "html",
...
La etiqueta \`<a>\` (anchor, o ancla) crea **hipervinculos** que permiten navegar entre páginas, secciones o recursos. Es uno de los elementos fundamentales de la web.
...
- **\`href\`** (Hypertext Reference): específica la URL de destino
...
Esto evita que la página de destino tenga acceso a la ventana que la abrio.

> **Buena práctica:** Siempre agrega \`rel="noopener noreferrer"\` cuando uses \`target="_blank"\`.`,
      codeExample: {
...
Usa el esquema \`tel:\` para iniciar una llamada (especialmente útil en móviles):

\`\`\`html
<a href="tel:+34612345678">Llamanos: +34 612 345 678</a>
\`\`\`

> **Consejo:** Los enlaces \`mailto:\` y \`tel:\` mejoran mucho la experiencia del usuario en dispositivos móviles.`,
      codeExample: {
...
Una URL relativa se basa en la **ubicación del archivo actual**. Se usa para enlazar páginas dentro del mismo sitio:
...
| Raíz | \`/pagina.html\` | Desde la raíz del sitio |
  ...
  exercises: [
    {
      ...
      xpReward: 10,
      order: 1,
      prompt: "¿Qué atributo de la etiqueta <a> específica la URL de destino?",
      options: [
      ...
      explanation:
        "El atributo href (Hypertext Reference) específica la URL de destino del enlace.",
    },
    {
      id: "html-04-ej-02",
    ...
    },
    {
      ...
      xpReward: 10,
      order: 3,
      prompt: "¿Cuál es la forma correcta de crear un enlace interno a una sección con id='info'?",
      options: [
    ...
    },
    {
      ...
      explanation:
        "Los enlaces web usan https://, los de correo mailto:, los de teléfono tel:, y los internos #id.",
    },
    {
      id: "html-04-ej-05",
      type: "live-editor",
